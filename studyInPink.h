...
int firstMeet(int& EXP1, int& EXP2, const int& E1){
    ...
    if(E1<0 || E1>999)
        ...
        if( E1>=400 && E1<=999 ){
            ...
            // information 5
            if ( E1>=800 && E1<=999 ){
                EXP2=ceil( (float)EXP2+(float)E1/7+9+(float)E1/9+11);
                if(EXP2>600){
                    EXP2=ceil( (float)EXP2+(float)E1/5+6);
